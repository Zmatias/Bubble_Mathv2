...
Shader "AmplifyShaderPack/Community/Dissolve Burn"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode2 = tex2D( _DisolveGuide, uv_DisolveGuide );
			float temp_output_73_0 = ( (-0.6 + (( 1.0 - (( _AnimateDissolve )?( saturate( _SinTime.y ) ):( _DissolveAmount )) ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2DNode2.r );
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-2288.524,317.7163;Float;False;Property;_DissolveAmount;Dissolve Amount;5;0;Create;True;0;0;0;False;0;False;0;0.364;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;136;-82.56501,173.5112;Inherit;False;Property;_Color0;Color 0;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;2.639016,0.9873328,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StickyNoteNode;152;-1248.531,755.3145;Inherit;False;380;144;;;0,0,0,1;The animated Edge values coming into the Smoothstep node create a disolve effect from our Disolve Guide texture, because we're sliding the blend range back and forth.;0;0
...
ASEEND*/
//CHKSM=FC2D7E85057AEDB72F253B34EBDC7CC62F060254